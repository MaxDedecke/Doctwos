...
| **Knoten** | `CodeEntity` + `DocumentChunk` (dedupliziert je `file_path`/Titel) | `CodeEntity` (BFS über 0–5 `hops` ab einer Wurzel-Entity) | `CodeEntity`, ermittelt über Datei+Zeilen-Überlappung mit dem Vektor-Treffer |
