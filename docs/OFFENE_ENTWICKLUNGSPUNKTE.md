...
| O-024 | Frontend-Architektur / Chat | Die Chat-Orchestrierung ist trotz O-004/O-005 noch umfangreich in `frontend/app/page.tsx` gebündelt. | `runChatStream`, Senden, Retry/Regenerate, Chat-Fokus und Session-Auswahl/-Löschung in einen klar abgegrenzten Chat-Controller bzw. passende Hooks überführen; SSE-, URL- und Fehlerverhalten beibehalten und testen. | O-004, O-005 |
| O-025 | Frontend-Architektur / Navigation | Datei-, Entity-, Dokument- und Panel-Navigation belegt weiterhin einen großen Teil von `frontend/app/page.tsx`. | `handlePanelFileSelect`, `handleDocFocusRequest`, History-Navigation und Fokusweitergabe in einen `usePanelNavigation`-Hook oder eine gleichwertige Domänenkomponente auslagern; Fixierung, Live-Panels und mobile Navigation regressionssicher abdecken. | O-004, O-005 |
