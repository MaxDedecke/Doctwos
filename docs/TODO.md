...
| 4 | O-305 | COBOL-Syntax-Recovery an realen Dialektfällen stabilisieren, damit lokale Fehler nicht ganze Divisions-, Paragraphen- und Feldstrukturen vernichten. | Offen. CardDemo, Bank of Z und IBM Z Open Editor neu indizieren; verbleibenden Text-Fallback je Datei begründen. |
