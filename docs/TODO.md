...
| 20 | O-253 | Mischsprachen in Editor, Graph, Zitaten und Agentenantworten korrekt anzeigen. | Teilweise umgesetzt: Editor unterstützt die Begleitsprachen-Endungen; Graphdetails zeigen das persistierte Entity-Sprachlabel; Agentenhinweise trennen die Sprachen und begrenzen Beziehungsbehauptungen auf Belege. Zitatnavigation nutzt weiterhin Datei und Originalzeile. Kleine Ende-zu-Ende-Probe für fünf Sprachen samt sichtbarem Analyseunterstützungsniveau steht aus. |
